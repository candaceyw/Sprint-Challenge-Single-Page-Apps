...
> Answer:
        ...
        Client-side routing uses less data and gnerally will view faster. When a user clicks on a link, the URL changes but the request to the server is prevented. It supports lazy loading sections of your application to save bandwidth & speed initial load.  It also allows smoother transitions and animations.
